...
class HostB(tk.Tk):
    ...
    def create_widgets(self):
        ...
        ttk.Label(results_frame, text="3. Texto Cifrado Recuperado:", font="-weight bold").grid(row=4, column=0, sticky="w", pady=2)
    ...
    def plotar_sinais_servidor(self, ami_data_list, bin_data_str):
        self.ax_ami_b.clear()
        self.ax_bin_b.clear()
        ...
        self.ax_ami_b.set_title('Onda AMI Recebida')
        self.ax_ami_b.set_ylim(-1.5, 1.5)
        self.ax_ami_b.grid(True)
        self.ax_bin_b.step(time_steps, bin_data_int, where='post', color='blue')
        self.ax_bin_b.set_title('Sinal Binário Decodificado')
        ...
        try:
            while True:
                ...
                if "final" in data:
                    ...
                    self.plotar_sinais_servidor(data["plot_ami"], data["plot_bin"])
